...
export class Buffer {
    ...
    #lastByteRead = undefined;
    #currentByteRead = undefined;
    constructor(buffer = new Uint8Array, options) {
        this.#buffer = buffer;
    ...
    #updateLastReadByte(currentByte) {
     ...
     */
    #branch(parent, length = 1, parentEnum) {
        ...
        while (fieldsProcessed < length) {
            ...
            if (generalEnumfields[enumerator].length === 'ArrayOfEnumBlockArrays') {
                ...
                while (arraysProcessed < fieldLength) { // TODO: This loop does not check for buffer errors.
                    ...
                    bytesProcessed += 2;
                    parent[enumerator][arraysProcessed] = {};
            ...
            // ENUM --> [ 00 × fieldLength ]
                ...
                const fieldLength = generalEnumfields[enumerator].length;
                const data = this.read(fieldLength);
                bytesProcessed += fieldLength;
                parent[enumerator] = [...data];
            }
