export const generalEnumfields = {
    ...
    '06B8': { length: 'Sized', type: 'String', name: 'Link' },
    ...
    '009E': { length: 4, type: 'IGMT', name: 'Message Type' },
    ...
    '020D': { length: 4, type: 'Integer', name: 'Player ID (2)' },
    ...
    '0398': { length: 4, type: 'Integer', name: 'Class ID' },
    ...
    '0664': { length: 4, type: 'Version', name: 'Version' },
    ...
    '0132': { length: 'ArrayOfEnumBlockArrays', name: 'Players' },
...
//# sourceMappingURL=Enumfields.js.map